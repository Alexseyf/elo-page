...
const FutureFeaturesSection: React.FC = () => {
  const futureFeatures: FutureFeature[] = [
    {
      id: 1,
      title: "Matrícula Online Integrada",
      description: "Ficha de matrícula 100% digital, integrada ao sistema financeiro e de turmas. Elimine o preenchimento de papéis, reduza erros e agilize o processo de entrada de novos alunos.",
      comingSoon: true,
      icon: (
    ...
    },
    {
      ...
      description: "Canal de comunicação seguro e oficial entre a escola e os pais. Centralize avisos, tire dúvidas e mantenha o histórico de conversas em um só lugar, separando o pessoal do profissional.",
      comingSoon: true,
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Sistema completo para gestão de mensalidades. Emissão automática de boletos, cobrança recorrente e painel financeiro para que os pais acompanhem pagamentos com facilidade.",
      comingSoon: true,
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
