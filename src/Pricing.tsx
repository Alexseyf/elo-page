      ...
      <div className="container mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="text-center mt-12 md:mt-16">
          <p className="text-blue-900 text-md">
            <i className="fas fa-info-circle mr-2 text-blue-icon"></i> Não encontrou o plano ideal? <a href="#contato" className="text-blue-900 hover:underline font-semibold">Entre em contato</a>! Podemos criar uma solução sob medida para sua escola.
          </p>
        </div>
      </div>
    </section>
