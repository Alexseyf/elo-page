                ...
                <div className="space-y-32">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1 relative">
                            ...
                            <div className="relative bg-white border-2 border-forest/10 rounded-[2.5rem] p-10 shadow-2xl">
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between p-5 bg-cream rounded-3xl border-2 border-forest/5 shadow-sm group hover:border-forest/20 transition-all">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 bg-forest rounded-2xl flex items-center justify-center text-ochre shadow-lg group-hover:scale-105 transition-transform">
                                                <Wallet className="w-6 h-6" />
                                            </div>
                                            <div>
                                                <p className="text-[10px] font-black uppercase tracking-widest text-forest/40">Relatório Consolidado</p>
                                                <p className="font-black text-forest text-lg">Berçário 1</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="grid grid-cols-1 gap-4">
                                        <div className="p-5 bg-ochre/5 rounded-3xl border-2 border-ochre/20 flex justify-between items-center group hover:bg-ochre/10 transition-all">
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 rounded-full bg-ochre animate-pulse"></div>
                                                <p className="font-bold text-forest">Total Entradas</p>
                                            </div>
                                            <p className="text-xl font-black text-ochre">R$ 14.200</p>
                                        </div>
                                        <div className="p-5 bg-terracotta/5 rounded-3xl border-2 border-terracotta/20 flex justify-between items-center group hover:bg-terracotta/10 transition-all">
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 rounded-full bg-terracotta"></div>
                                                <p className="font-bold text-forest">Total Despesas</p>
                                            </div>
                                            <p className="text-xl font-black text-terracotta">- R$ 8.450</p>
                                        </div>
                                    </div>

                                    <div className="pt-4 mt-2 border-t border-forest/5 flex justify-between items-end">
                                        <div>
                                            <p className="text-[10px] font-black uppercase tracking-widest text-forest/40">Margem por Turma</p>
                                            <p className="text-3xl font-black text-forest">R$ 5.750</p>
                                        </div>
                                        <div className="px-3 py-1 bg-forest text-ochre text-[10px] font-black rounded-full uppercase tracking-tighter">
                                            Performance Alta
                                        </div>
                                    </div>
                                </div>
