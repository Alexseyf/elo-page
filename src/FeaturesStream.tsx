  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center py-16 first:pt-0 border-b border-brand-100 last:border-0">
    <div className="lg:col-span-6 order-2 lg:order-1 space-y-4">
      <div className="flex flex-wrap items-center gap-3">
        <div className={`w-12 h-12 ${iconBg} rounded-2xl flex items-center justify-center border border-brand-100 shrink-0`}>
          {icon}
        </div>
...
const FeaturesStream: React.FC = () => {
  return (
    <Section id="funcionalidades" className="bg-white">
      ...
      >
        <div className="bg-white border border-brand-100 rounded-3xl p-5 sm:p-7 shadow-card space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-brand-100">
            ...
            <span className="self-start sm:self-auto text-xs font-bold bg-blue-50 text-accent border border-blue-200/60 px-2.5 py-1 rounded-lg flex items-center gap-1.5 shrink-0 whitespace-nowrap">
          ...
          <div className="p-4 bg-blue-50/60 rounded-2xl border border-blue-200/60 space-y-2">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5">
              ...
              <span className="self-start sm:self-auto text-[11px] font-bold text-accent bg-white px-2 py-0.5 rounded shadow-subtle shrink-0 whitespace-nowrap">
                Pronta para Uso
              </span>
            </div>
          ...
          <div className="pt-2 flex justify-end">
            <button className="w-full sm:w-auto text-xs font-bold bg-accent text-white px-4 py-2.5 rounded-xl hover:bg-accent-dark transition-all flex items-center justify-center gap-1.5 shadow-subtle">
      ...
      >
        <div className="bg-white border border-brand-100 rounded-3xl p-5 sm:p-7 shadow-card space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-brand-100">
            ...
            <span className="self-start sm:self-auto text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/60 px-2.5 py-1 rounded-lg shrink-0 whitespace-nowrap">
          ...
          <div className="pt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-t border-brand-100">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-emerald-500 shrink-0" />
              <span className="text-xs font-bold text-brand-800">Ciente pela Responsável em 04/07</span>
            </div>
            <button className="w-full sm:w-auto text-xs font-bold bg-brand-50 text-brand-800 border border-brand-200 px-3 py-2 rounded-lg hover:bg-brand-100 transition-colors flex items-center justify-center gap-1.5 shadow-subtle shrink-0">
      ...
      >
        <div className="bg-white border border-brand-100 rounded-3xl p-5 sm:p-7 shadow-card space-y-4">
          ...
          <div className="space-y-2 text-xs">
            <div className="p-3.5 bg-brand-50/70 rounded-2xl border border-brand-100 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <p className="font-bold text-brand-900 text-xs">Helena Rodrigues (Berçário 2)</p>
                <p className="text-[11px] text-brand-500">Resp: Carlos Rodrigues · CPF: ***.482.910-**</p>
              </div>
              <span className="self-start sm:self-auto text-[11px] font-bold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-md border border-emerald-200/60 shrink-0 whitespace-nowrap">
            ...
            <div className="p-3.5 bg-brand-50/70 rounded-2xl border border-brand-100 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <p className="font-bold text-brand-900 text-xs">Lucas Mendes (Maternal 1)</p>
                <p className="text-[11px] text-brand-500">Termo Aditivo: Desconto Pontualidade Ativo</p>
              </div>
              <span className="self-start sm:self-auto text-[11px] font-bold text-blue-700 bg-blue-50 px-2.5 py-1 rounded-md border border-blue-200/60 shrink-0 whitespace-nowrap">
                Aditivo Homologado
              </span>
            </div>
          </div>

          <div className="p-3 bg-brand-50 rounded-2xl border border-brand-100 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs font-semibold text-brand-700">
            <span>Link de Assinatura via Celular</span>
            <button className="self-start sm:self-auto text-xs font-bold text-accent underline hover:text-accent-dark">
      ...
      >
        <div className="bg-white border border-brand-100 rounded-3xl p-5 sm:p-7 shadow-card space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-brand-100">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-rose animate-pulse shrink-0" />
              <p className="text-xs font-bold text-brand-900 uppercase">Registro Formal de Incidente</p>
            </div>
            <span className="self-start sm:self-auto text-[10px] font-mono font-bold text-brand-600 bg-brand-50 px-2 py-1 rounded border border-brand-100 shrink-0 whitespace-nowrap">
              HASH: #9cf2b810
            </span>
          </div>
          ...
          <div className="p-3 bg-emerald-50 rounded-2xl border border-emerald-200/60 flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-xs font-bold text-emerald-800">
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
              Ciência Confirmada pelos Pais
            </span>
            <span className="text-[11px] font-normal text-emerald-700 shrink-0 whitespace-nowrap">Hoje às 11:05h</span>
          </div>
        </div>
      </FeatureCard>
      ...
      >
        <div className="bg-white border border-brand-100 rounded-3xl p-5 sm:p-7 shadow-card space-y-4">
          ...
          <div className="p-4 bg-brand-50 rounded-2xl border border-brand-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
            ...
            <span className="self-start sm:self-auto text-xs font-bold bg-blue-50 text-accent border border-blue-200/60 px-3 py-1.5 rounded-xl shadow-subtle shrink-0 whitespace-nowrap">
              41.3% Lucratividade
            </span>
          </div>
        </div>
        ...
        <div className="bg-white border border-brand-100 rounded-3xl p-5 sm:p-7 shadow-card space-y-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
            {[
              ...
              <div key={item.label} className="p-3 bg-brand-50/70 rounded-2xl flex flex-col items-center gap-1 border border-brand-100 text-center shadow-subtle">
                <span className="text-xl">{item.icon}</span>
                <span className="text-[10px] font-bold text-brand-500 uppercase">{item.label}</span>
                <span className="text-xs font-bold text-brand-900 whitespace-nowrap">{item.status}</span>
              </div>
            ))}
          </div>

          <div className="p-4 bg-brand-50/70 rounded-2xl border border-brand-100 flex flex-col sm:flex-row sm:items-center gap-3.5">
            <div className="w-12 h-12 bg-accent text-white rounded-2xl flex flex-col items-center justify-center text-xs font-bold leading-none shrink-0 shadow-subtle self-start sm:self-auto">
