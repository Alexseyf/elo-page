...
const HeroSection: React.FC = () => {
  return (
    <section className="h-auto bg-white text-blue-900 py-16 md:py-20 px-4">
      <div className="container mx-auto max-w-6xl mt-24 md:mt-8">
        ...
        <div className="mt-10 flex justify-center">
          <button className="bg-blue-900  hover:bg-blue-800  text-blue-text font-bold py-3 px-8 rounded-full text-lg transition-all">
