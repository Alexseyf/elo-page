...
const FooterSection: React.FC = () => {
  return (
    <footer className="bg-forest text-white py-20 px-4 relative overflow-hidden">
      {/* Decorative */}
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-ochre/10 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl"></div>

      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6 justify-center md:justify-start">
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-forest shadow-lg rotate-3 group hover:rotate-0 transition-transform cursor-pointer">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-sm font-black uppercase tracking-widest text-ochre mb-6">Explorar</h3>
            <ul className="space-y-4">
              {['Sobre Nós', 'Para Escolas', 'Para Pais', 'Contato'].map(item => (
                <li key={item}>
                  <a href="#" className="text-white/60 hover:text-ochre transition-colors font-bold">
                    {item}
                  </a>
                </li>
              ))}
          ...
          {/* Políticas */}
          <div className="text-center md:text-left">
            <h3 className="text-sm font-black uppercase tracking-widest text-ochre mb-6">Políticas</h3>
            <ul className="space-y-4">
        ...
        <div className="mt-20 pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex space-x-6">
            <a href="#" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-ochre hover:text-forest transition-all text-white/60">
              <Facebook size={20} />
            </a>
            <a href="#" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-ochre hover:text-forest transition-all text-white/60">
              <Instagram size={20} />
