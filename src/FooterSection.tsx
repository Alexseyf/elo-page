        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-blue-700 hover:text-blue-900 transition-colors">Sobre Nós</a></li>
              <li><a href="#" className="text-blue-700 hover:text-blue-900 transition-colors">Para Escolas</a></li>
              <li><a href="#" className="text-blue-700 hover:text-blue-900 transition-colors">Para Pais</a></li>
              <li><a href="#" className="text-blue-700 hover:text-blue-900 transition-colors">Contato</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-blue-700 hover:text-blue-900 transition-colors">Política de Privacidade</a></li>
              <li><a href="#" className="text-blue-700 hover:text-blue-900 transition-colors">Termos de Uso</a></li>
              <li><a href="#" className="text-blue-700 hover:text-blue-900 transition-colors">Política de Cookies</a></li>
            </ul>
          </div>
        </div>
